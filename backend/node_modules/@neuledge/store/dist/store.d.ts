import { StoreCollection_Slim, StoreCollection, StoreField, StoreIndex } from './collection';
import { StoreDocument, StoreList, StoreListOffset, StoreSelect } from './document';
...
export interface Store {
    ...
    describeCollection(options: StoreDescribeCollectionOptions): Promise<StoreCollection>;
