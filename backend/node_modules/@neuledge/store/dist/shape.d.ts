 ...
 * @see StoreShapeType
 */
export type TypeofStoreShapeType<T extends StoreShapeType> = StoreShapeTypeMap[T];
/**
 ...
 * @see StoreShapeType
 */
export type StoreValueShapeType<Value> = Value extends string ? 'string' | 'enum' : Value extends number | bigint ? 'number' : Value extends boolean ? 'boolean' : Value extends Uint8Array ? 'binary' : Value extends Date ? 'date-time' : 'json';
