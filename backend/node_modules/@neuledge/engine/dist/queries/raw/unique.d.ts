...
export interface UniqueQuery<M extends QueryMode, I extends StateDefinition, O extends StateDefinition, P extends QueryProjection<O> = null, R = NonNullable<unknown>> {
    /**
...
type NonCommonUniqueKeys<S extends StateDefinition> = {
    [K in StateName<S>]: Exclude<AllKeys<StateUnique<S>>, S extends StateDefinition<K> ? AllKeys<StateUnique<S>> : never>;
}[StateName<S>];
export {};
