...
export type StateAllRelations<S extends StateDefinition> = keyof StateRelations<S>;
...
export type StateRelationStates<S extends StateDefinition, K extends StateAllRelations<S>> = StateRelations<S>[K] extends {
    states: readonly StateDefinition[];
} ? StateRelations<S>[K]['states'][number] : never;
