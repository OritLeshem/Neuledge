...
export interface Scalar<Type = any, // eslint-disable-line @typescript-eslint/no-explicit-any
Input = Type, Value = Type, ShapeType extends StoreValueShapeType<Value> = StoreValueShapeType<Value>> {
    /**
 ...
 */
export type ScalarType<S extends Scalar> = S extends Scalar<infer T, any, // eslint-disable-line @typescript-eslint/no-explicit-any
any> ? T : never;
/**
 * Infers the input type of a scalar.
 */
export type ScalarInput<S extends Scalar> = S extends Scalar<any, // eslint-disable-line @typescript-eslint/no-explicit-any
infer T, any> ? T : never;
/**
 * Infers the value type of a scalar.
 */
export type ScalarValue<S extends Scalar> = S extends Scalar<any, // eslint-disable-line @typescript-eslint/no-explicit-any
any, // eslint-disable-line @typescript-eslint/no-explicit-any
infer T> ? T : never;
/**
 * Infers the encoding type of a scalar.
 */
export type ScalarEncoding<S extends Scalar> = S extends Scalar<any, // eslint-disable-line @typescript-eslint/no-explicit-any
any, // eslint-disable-line @typescript-eslint/no-explicit-any
any, // eslint-disable-line @typescript-eslint/no-explicit-any
infer T> ? T : never;
